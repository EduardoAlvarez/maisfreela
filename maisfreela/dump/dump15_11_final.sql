...
CREATE TABLE `desenvolvedor` (
  ...
  CONSTRAINT `FK_rtmt229j23m4a2513q5prodk2` FOREIGN KEY (`id_contaBancaria`) REFERENCES `contaBancaria` (`id_conta`)
...
INSERT INTO `desenvolvedor` VALUES (1,4.2,NULL,1);
...
CREATE TABLE `empresario` (
  ...
  CONSTRAINT `FK_n8ctwh7pheqpfnboayf4o963b` FOREIGN KEY (`id_contaBancaria`) REFERENCES `contaBancaria` (`id_conta`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `empresario` VALUES (1,3.2,NULL,2);
...
-- Dump completed on 2014-11-15 16:08:19
