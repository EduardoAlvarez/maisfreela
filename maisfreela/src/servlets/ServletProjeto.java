		...
		switch (acao) {
			...
			case "cancelarProjetoAction":
				...
				try {
					NotifyController.enviarNotificacao("Projeto cancelado", 
						"O projeto: "+cancelar_proj.getTitulo()+" foi cancelado! Voce recebera 40% do valor j� pago.", 
			...
			case "encerrarProjetoAction":
				...
				NotifyController.enviarNotificacao("Projeto Encerrado",
						"O projeto "+encerrar_proje.getTitulo()+ " foi encerrado pelo Empres�rio "+encerrar_proje.getEmpresario().getUsuario().getNome()+ 
						", favor confirmar o encerramento do projeto! N�o se esque�a de avaliar o Empres�rio!",  
