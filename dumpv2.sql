...
CREATE TABLE `Lance` (
  ...
  KEY `FK_otrsyk5bctaley8cuv3myph78` (`id_usuario`),
  CONSTRAINT `FK_otrsyk5bctaley8cuv3myph78` FOREIGN KEY (`id_usuario`) REFERENCES `Usuario` (`id_usuario`),
...
-- Dump completed on 2014-10-17 20:46:18
